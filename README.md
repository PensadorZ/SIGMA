...
(`0011-viz-reporter`), not simulated or hand-crafted:

**Tirendaz — post-restructuring run** (baseline, `warnings=[]`)
![Tirendaz dashboard](assets/dashboard_screenshots/dashboard_run4_tirendaz.png)

**IMDb reviews — cross-domain test** (long-form text, `warnings=[]`)
![IMDb dashboard](assets/dashboard_screenshots/dashboard_run5_imdb.png)

**Social Media 2026 — cross-domain test** (triggered the HITL quality gate correctly)
![Social media dashboard](assets/dashboard_screenshots/dashboard_run6_social.png)

Full interactive dashboards: [`outputs/`](outputs/) (download and open
locally — GitHub shows raw HTML source, not the rendered page).
