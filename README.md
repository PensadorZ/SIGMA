...
- [✅ Tirendaz — post-restructuring run](outputs/dashboard_run4_ok.html) — baseline, `warnings=[]`
- [✅ IMDb reviews — cross-domain test](outputs/dashboard_run5_imdb_ok.html) — long-form text, `warnings=[]`
- [✅ Social Media 2026 — cross-domain test](outputs/dashboard_run6_social_ok_warnings.html) — triggered the HITL quality gate correctly
