...
> invoca opcionalmente tras recibir el `VizReporterOutput`. Está formalizada
> en ADR-012.
...
| ADR-012 | La integración con Netlify se implementa como hook externo conforme a ADR-012; nunca dentro de este skill |
